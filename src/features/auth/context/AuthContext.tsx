...
import type {AuthUser, AuthContextValue, SignupArgs, LoginArgs, 
  MessageResponse, RequestPasswordResetArgs,VerifyEmailArgs, 
  PasswordResetArgs, AuthMessageMap} from "../api/schemas/auth.types";
...
export function AuthProvider({ children } : AuthProviderProps) {
  ...
  /* ======================
      RESET PASSWORD CONFIRM THE RESET WITH NEW AND OLD PASSWORDS
  ====================== */
