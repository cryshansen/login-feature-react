...
import UnAuthFacingHeader from "./UnAuthFacingHeader";
import AuthFacingFooter from "./AuthFacingFooter";


export default function UnAuthLayout({  darkMode, setDarkMode }) {

  darkMode = true; // temp for testing
  return (
    <div className="min-h-screen flex flex-col w-screen">
      <HeaderTopLevel darkMode={darkMode} />
      <UnAuthFacingHeader darkMode={darkMode}  setDarkMode={setDarkMode} />
